...
export const DEFAULT_TEMPLATES = {
  usage: {
    ...
    body: [
      'Hi {{name}},',
      'A-Bar works best when you give it a head start. Eat it <strong>30–45 minutes before</strong> the moment that matters — not during it.',
    ...
    footnote: '',
    // Utility category: tied to an existing order, ~₹0.115 in India and the
    // most defensible thing to send without a marketing opt-in.
  ...
  reviewRequest: {
    ...
    // Marketing category because of the ₹20 incentive: ~₹0.86 and needs opt-in.

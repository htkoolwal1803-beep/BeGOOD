...
export const products = [
  {
    ...
    usage: 'Enjoy one bar shortly before a high-stakes moment. A-Bar is designed to act in less than 20 minutes. Individual experiences vary. Do not use this food as a substitute for medical care.',
    reviews: [
      {
        name: 'Siddhant',
        role: 'Student',
  ...
  },
  {
    ...
    bundleQty: 2,
    keyAspects: ['2 × A-Bar (40g each)', 'L-Theanine', 'Magnesium Glycinate', 'Chicory Root Extract', 'Acts in less than 20 minutes'],
    ingredients: abarKeyIngredients,
    fullIngredients: abarFullIngredients,
    ...
    usage: 'Enjoy one bar shortly before a high-stakes moment. A-Bar is designed to act in less than 20 minutes. Individual experiences vary.'
  },
  {
    ...
    bundleOf: 'begood-abar-001',
    bundleQty: 5,
    keyAspects: ['5 × A-Bar (40g each)', 'Free delivery included', 'L-Theanine', 'Magnesium Glycinate', 'Acts in less than 20 minutes'],
    ingredients: abarKeyIngredients,
    fullIngredients: abarFullIngredients,

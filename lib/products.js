import { PRODUCT_IMAGE as ABAR_HERO_SRC } from '@/lib/seo'
...
export const abarKeyIngredients = [
  ...
  },
  {
    ...
    benefit: 'Chicory root is a source of fibre included in the formulation.'
  }
]
...
export const abarFullIngredients = [
  ...
  { name: 'Chicory Powder (Cichorium intybus)' },
  { name: 'Cocoa Powder (Theobroma cacao)' },
  ...
  { name: 'Honey' },
  { name: 'Pink Salt' },
  { name: 'Magnesium Glycinate (Amino Acid Chelate of Magnesium)' },
  { name: 'Soy Lecithin' },
...
export const products = [
  {
    ...
    howItWorks: 'A-Bar brings three functional ingredients into one easy ritual. L-Theanine is studied for relaxed alertness, magnesium supports normal nervous-system function, and chicory root contributes fibre. Ingredient research does not establish the effects of the finished A-Bar. The chocolate format makes the routine simple to use before moments that matter.',
    usage: 'Enjoy one bar shortly before a high-stakes moment. A specific onset time has not been established for A-Bar. Individual experiences vary. Do not use this food as a substitute for medical care.',
    reviews: [
      {
        name: 'Siddhant',
        role: 'Student',
  ...
  },
  {
    ...
    bundleQty: 2,
    keyAspects: ['2 × A-Bar (40g each)', 'L-Theanine', 'Magnesium Glycinate', 'Chicory Root Extract', '40 g per bar'],
    ingredients: abarKeyIngredients,
    fullIngredients: abarFullIngredients,
    ...
    usage: 'Enjoy one bar shortly before a high-stakes moment. A specific onset time has not been established for A-Bar. Individual experiences vary.'
  },
  {
    ...
    bundleOf: 'begood-abar-001',
    bundleQty: 5,
    keyAspects: ['5 × A-Bar (40g each)', 'Free delivery included', 'L-Theanine', 'Magnesium Glycinate', '40 g per bar'],
    ingredients: abarKeyIngredients,
    fullIngredients: abarFullIngredients,

...
const LINKEDIN_VERSION = optionalEnv('LINKEDIN_VERSION', '202607')
...
export async function connectLinkedInFromCode(code) {
  ...
  await saveConnection('linkedin', {
    ...
    refreshTokenExpiresAt: token.refresh_token_expires_in
      ...
      : null,
    organizationId: requiredEnv('LINKEDIN_ORGANIZATION_ID'),
    apiVersion: LINKEDIN_VERSION
  })

  return { organizationId: requiredEnv('LINKEDIN_ORGANIZATION_ID') }
}
